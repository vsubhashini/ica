...
\begin{center}
   \subfloat[Recovering a mixture of 2, 3, and 4]{\includegraphics[width=8.3cm]{../plots/Annealrecover-srcs-234.png}}
   \subfloat[Recovering a mixture of 2, 3, and 5]{\includegraphics[width=8.3cm]{../plots/Annealrecover-srcs-235.png}}
\end{center}
\end{tabularx}
...
\end{center}
%\end{tabularx}
\caption{Recovering signals by additionally varying $\beta$.}\label{fig:exp4}
\end{figure}
